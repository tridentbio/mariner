...
from app.features.model.model import Experiment, Model
from app.features.model.schema.model import TrainingRequest
...
def test_create_model_training(db: Session, some_model: Model):
    ...
    print(request)
    exp = model_ctl.create_model_traning(db, user, request)
