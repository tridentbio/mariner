...
### Live development with Python Jupyter Notebooks -> TEST!
...
Frontend: https://dev.mariner.trident.bio

Backend: https://dev.mariner.trident.bio/api/
...
Frontend: http://local.mariner.trident.bio

Backend: http://local.mariner.trident.bio/api/

Automatic Interactive Docs (Swagger UI): https://local.mariner.trident.bio/docs

Automatic Alternative Docs (ReDoc): https://local.mariner.trident.bio/redoc
